...
; Produces a single-file MyAIAgentHub-Setup.exe
; Run via build_windows.bat or: iscc build\installer.iss

#define AppName "MyAI Agent Hub"
#define AppVersion "1.0.0"
#define AppPublisher "MyAI Agent Hub"
...
OutputDir=dist
OutputBaseFilename=MyAIAgentHub-Setup
